...
class OrderGoods extends ActiveRecord
{
    ...
    public  static  function  FindOrderNumBer($user)
    {
        if ($user->last_role_id_app==Yii::$app->params['supplierRoleId'])
        {
            ...
            $data = (new Query())
                ->select("(SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.supplier_id={$supplier->id}   and g.order_refer=2) as all_order ,
            ...
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=0 and shipping_status=0  and g.supplier_id={$supplier->id}   and g.order_refer=2) as unshipped,
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=0 and shipping_status=1  and g.supplier_id={$supplier->id}    and g.order_refer=2) as unreceived,
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=1 and shipping_status=2  and g.supplier_id={$supplier->id} and o.customer_service=0    and g.order_refer=2)  as completed,
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=1 and shipping_status=2  and g.supplier_id={$supplier->id} and o.customer_service=0 and o.comment_id=0   and g.order_refer=2 )  as uncomment,
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where o.order_status=2 and o.customer_service=0  and g.supplier_id={$supplier->id}  and g.order_refer=2  )as canceled,
            (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where o.order_status=1  and  o.customer_service!=0  and g.supplier_id={$supplier->id}   and g.order_refer=2 )  as customer_service" )
                ->one();
        }else
        {
            $data=(new Query())->select("
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.user_id={$user->id} and g.role_id = {$user->last_role_id_app}   and g.order_refer=2) as all_order ,
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=0 and o.order_status=0  and  g.user_id={$user->id} and g.role_id = {$user->last_role_id_app}   and g.order_refer=2) as unpaid ,
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=0 and shipping_status=0  and  g.user_id={$user->id} and g.role_id = {$user->last_role_id_app}    and g.order_refer=2)  as unshipped ,
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=0 and shipping_status=1  and  g.user_id={$user->id} and g.role_id = {$user->last_role_id_app}    and g.order_refer=2)  as unreceived ,
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=1 and shipping_status=2  and  g.user_id={$user->id} and g.role_id = {$user->last_role_id_app} and o.customer_service=0    and g.order_refer=2)  as completed ,
               (SELECT count(*)  FROM  " .GoodsOrder::tableName()." as g "." LEFT JOIN  ".OrderGoods::tableName()." as o on g.order_no=o.order_no where g.pay_status=1 and o.order_status=1 and shipping_status=2  and g.user_id={$user->id} and g.role_id = {$user->last_role_id_app} and o.customer_service=0 and o.comment_id=0    and g.order_refer=2)   as uncomment ,
