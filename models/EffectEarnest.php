...
class EffectEarnest extends \yii\db\ActiveRecord
{
    ...
    public static function getallapply(){
        ...
        return $sum=(new Query())->from('effect_earnest')->where('type=0')->count('*');
    }
    ...
    public static function gettodayapply(){
        ...
        return $sum=(new Query())->from('effect_earnest')->where('create_time<='.$today[1])->andWhere('create_time>='.$today[0])->andWhere('type=0')->count('*');
    }
