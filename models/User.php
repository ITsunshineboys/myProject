...
//        }
    ...
    public function switchRole($roleId)
    {
        ...
        if (!$roleId
            ...
            !$roleId && StringService::writeLog('test', 'no role id');
            !in_array($roleId, UserRole::findRoleIdsByUserIdAndReviewStatus($this->id)) && StringService::writeLog('test', 'not authorized');
            return 1000;
        }
