...
union
SELECT send_uid uid, send_role_id role_id,id,content,`type`,send_time,status,del_status FROM (select * from chat_record  where to_role_id=$role_id and to_uid=$u_id order by id desc) tmp group by send_uid,send_role_id
