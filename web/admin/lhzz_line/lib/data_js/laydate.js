...
;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        }), c[c.valid ? "removeClass" : "addClass"](h.ok, h[1]),c[c.valid ? "removeClass" : "addClass"](h.otoday, h[1])
        ...
        c.shde(b.time, !c.options.istime), c.shde(h.oclear, !("isclear" in c.options ? c.options.isclear : 1)),
        ...
        }() + "</div>" + "</div>" + "</div>" + c.viewtb + '<div class="laydate_bottom" style="height: 30px">' + '<ul id="laydate_hms">' + '<li class="laydate_sj">时间</li>' + "<li><input readonly>:</li>" + "<li><input readonly>:</li>" + "<li><input readonly></li>" + "</ul>" + '<div class="laydate_time" id="laydate_time"></div>' + '<div class="laydate_btn">' + '<a id="laydate_clear">清空</a>' +
            '<a id="laydate_today" style="display: none;">今天</a>' +
            '<a id="laydate_ok">确认</a>' + "</div>" + (b.isv ? '<a href="http://sentsin.com/layui/laydate/" class="laydate_v" target="_blank">laydate-v' + laydate.v + "</a>" : "") + "</div>", d.body.appendChild(i), c.box = g("#" + h[0]), c.events(), i = null), c.follow(c.box), f.zIndex ? c.box.style.zIndex = f.zIndex : c.removeCssAttr(c.box, "z-index"), c.stopMosup("click", c.box), c.initDate(), c.iswrite(), c.check()
    }, c.reshow = function () {
        ...
        c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"), c.each(b(e.box + " .laydate_ym"), function (a, b) {
            ...
            c.elem[h.elemv] = "", c.close(),"function" == typeof c.options.choose && c.options.choose(f)
        }), h.otoday = b("#laydate_today"), c.on(h.otoday, "click", function () {
            // c.valid && c.creation([c.ymd[0], c.ymd[1] + 1, c.ymd[2]])
            c.elem[h.elemv] = laydate.now(0, c.options.format), c.close(),"function" == typeof c.options.choose && c.options.choose(f)
