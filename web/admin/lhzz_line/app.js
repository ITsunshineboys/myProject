var app = angular.module("app",["ueditor.directive","intelligent_directive","ui.router","banner_recommend_module","index_recommend_module","banner_history_module","index_recommend_history_module","index_module","clamagModule","onsaleeditModule","offsaleeditModule","addclassModule"]);
/*路由拦截*/
app.config(function ($stateProvider,$httpProvider) {
  ...
  $stateProvider.state("banner_recommend",{   //APP推荐-banner
    ...
    .state("onsale_edit",{
    params:{"classtitle":null,"classid":null,"classlevel":null,"classpath":null},
    url:"/onsale_edit",
