...
//        $material['total_cost'] = $total_material_cost;
    ...
    public function actionAddMaterials()
    {
        ...
        $add_select = 'decoration_add.id,decoration_add.one_materials,decoration_add.two_materials,decoration_add.three_materials,decoration_add.sku,max(d.quantity) as quantity';
...
//            }
    ...
    public function actionAssortFacility()
    {
        ...
        // 有资料 计算公式
        $materials = ['木地板','人造大理石','弯头','木门','浴霸','换气扇','吸顶灯','水龙头','床','床头柜','抽油烟机','灶具','立柜式空调','挂壁式空调','灯具','床垫','马桶','浴柜','花洒套装','淋浴隔断'];
...
//        var_dump(StairsDetails::find()->asArray()->all());
         $r = \Yii::$app->db->createCommand()->update('stairs_details',['attribute'=>'纯钢构造'],['id'=>4]);
