...
//        unset($logisticsTemplate->name);
    ...
    {
//        return StringService::httpGet('http://cdlhzz.cn:9200', 'admin', 'admin_pw');
//        $data = ["name" => "WashingTon Jorge"];
        $data = ["user" => "kitty", 'post_date' => "2010-11-18T16:17:17", 'message' => "The fourth tweet, will it be indexed?"];
//        $res = StringService::httpPost('http://local.es.com/twitter/tweet/1', json_encode($data));
//        $data = [
//            'query' => [
...
//            ],
//        ];
//        $res = StringService::httpGet('http://local.es.com/_search', json_encode($data));
//        $data = [
//            'query' => [
//                'match' => [
//                    'text' => [
...
//    }
//}';
//        $res = StringService::httpGet('http://local.es.com/bookdb_index/book/_search?q=title:in%20action&size=1&from=1');
        $res = StringService::httpPost('http://cdlhzz.cn:9200/bookdb_index/book/_search', $jsonData, 'admin', 'admin_pw');
//        $res = StringService::httpPost('http://local.es.com/bookdb_index/book/_search', json_encode($data));
//        $res = StringService::httpDelete('http://local.es.com/twitter/tweet/4');
//        $res = StringService::httpPut('http://local.es.com/twitter/user/kitty', json_encode($data));
//        die($res);
