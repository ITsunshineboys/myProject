...
return [
    ...
    'errorCodes' => [
        ...
        1078 => '没有此商品,请重新输入',
        1079 => '商品编号重复,请重新输入',
        1080 => '此分类下没有商品，或该商品已下架',
        1081 => '您尚未设置支付密码，请先去设置',
        1082 => '同一用户今日相互聊天次数已达上限，请明天再来吧!',
        1083 => '商品不支持配送至该地区!',
        1084 => '请勿绑定自身用户!',
        1085 => '商品库存不足!',
        1086 => '该商品已下架,请重新输入!',
        ...
        1089 => '该商家未通过审核，无法开启',
        1090 => '请勿重复评论！',
        1091 => '您尚未实名认证，请先进行实名认证！',
        1092 => '您实名认证未通过，请先进行实名认证！',
        1093 => '商品品牌所属分类已移除，请添加品牌分类后上架商品',
        1094 => '商品所在分类已移除，请商家重新添加新商品',
        1095 => '此属性用于智能报价计算，请勿删除',
        1096 => '该地址已不存在，请重新添加',
        1097 => '您尚未加入分销.',
        1098 => '支付失败',
        1099 => '您已经加入了分销',
        1100 => '请先开启线下体验店，再开启该商品',
        1101 => '该商品的所属商家店铺已关闭，不能开启',
        1102 => '该商品已下架，不能开启',
        1103 => '今日申请次数已超过3次',
        1104 => '请输入银行卡名',
        1105 => '请输入银行卡号',
        1106 => '请输入持卡人姓名',
        1107 => '商家店铺已闭店，请先开启商家店铺，再开启线下体验店',
        1108 => '所属上级分类已下线，请先上架上级分类',
    ],
    'okMsgs' => [
...
//    'auth' => $auth,
    ...
    'user' => [
        ...
        'default_icon_path' => '/uploads/user_icon_default.png', // 默认头像
    ],
    //聊天服务配置
    'chatOptions' => [
